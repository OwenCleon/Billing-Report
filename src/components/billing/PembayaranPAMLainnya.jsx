            ...
            {filteredData.length === 0 ? (
              ...
              filteredData.map((item) => (
                <TableRow key={item.id}>
                  <TableCell className="font-medium">{item.noPelanggan}</TableCell>
...
export default PembayaranPAMLainnya;